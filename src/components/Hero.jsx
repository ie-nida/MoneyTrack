      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          ...
          <p className={`${styles.paragraph} ml-2`}>
            <span className="text-white">Limited Time:</span> 30%{" "}
            <span className="text-white">Off Your</span> First 3 Months
          </p>
        </div>
        ...
        Tired of spreadsheet chaos? MoneyTrack turns financial headaches into clear insights. Small business owners like you save 5+ hours weekly while gaining complete financial clarity.
        </p>
      </div>
